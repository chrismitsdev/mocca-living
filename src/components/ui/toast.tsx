    ...
    <SonnerToaster
      toastOptions={{
        ...
        classNames: {
          ...
          success: 'flex gap-2 items-center !bg-green-3 !border-border-success text-success',
          error: 'flex gap-2 items-center !bg-red-3 !border-border-error text-error',
          info: 'flex gap-2 items-center !bg-blue-3 !border-border-info text-info',
          warning: 'flex gap-2 items-center !bg-yellow-3 !border-border-warning',
          closeButton:
