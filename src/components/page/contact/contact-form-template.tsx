            ...
            <Section className='p-4'>
              ...
              <Row>
                <Column>
                  ...
                  <Text className='my-0 mt-1'>Σπίτι:</Text>
                ...
                <Column>
                  ...
                  <Text className='my-0 mt-1 font-[700]'>{formatDate(formData.checkIn, 'gr', 'PPP')}</Text>
                  <Text className='my-0 mt-1 font-[700]'>{formatDate(formData.checkOut, 'gr', 'PPP')}</Text>
                  <Text className='my-0 mt-1 font-[700]'>{formData.house}</Text>
