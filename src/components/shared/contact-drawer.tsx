    ...
    <Drawer>
      <DrawerTrigger asChild>
        <IconButton
          ...
          className='fixed inset-be-16 inset-e-3 data-variant-outline:bg-success data-variant-outline:text-success-foreground data-variant-outline:border-success data-variant-outline:hover:bg-success-hover data-variant-outline:hover:border-success-hover sm:hidden'
          variant='outline'
        >
          <IconBubbleTextFilled />
        </IconButton>
