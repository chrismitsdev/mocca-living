            ...
            <Form
              ...
              fieldTranslations={{
                name: {
                  ...
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.name.validation.required'
                    ),
                    length: t(
                      'Pages.Contact.Form.fields.name.validation.length'
                    )
                  }
                },
                email: {
                  ...
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.email.validation.required'
                    ),
                    pattern: t(
                      'Pages.Contact.Form.fields.email.validation.pattern'
                    ),
                ...
                phone: {
                  ...
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.phone.validation.required'
                    ),
                    pattern: t(
                      'Pages.Contact.Form.fields.phone.validation.pattern'
                    )
                  }
                },
                checkIn: {
                  ...
                  placeholder: t(
                    'Pages.Contact.Form.fields.checkIn.placeholder'
                  ),
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.checkIn.validation.required'
                    )
                  }
                },
                checkOut: {
                  ...
                  placeholder: t(
                    'Pages.Contact.Form.fields.checkOut.placeholder'
                  ),
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.checkOut.validation.required'
                    )
                  }
                },
                villa: {
                  ...
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.villa.validation.required'
                    )
                  }
                },
                message: {
                ...
                consentData: {
                  ...
                  validation: {
                    required: t(
                      'Pages.Contact.Form.fields.consentData.validation.required'
                    )
                  }
                }
              }}
